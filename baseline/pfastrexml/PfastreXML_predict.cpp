...
void help()
{
	...
	cerr<<"./PfastreXML_predict [feature file name] [score file name] [model folder name] -S 0 -T 1 -s 0 -t 50 -n 1000 -q 1"<<endl<<endl;
...
int main(int argc, char* argv[])
{
	...
	SMatF* pf_score_mat = predict_trees(tst_X_Xf, pfparam, model_folder, predict_time, model_size);
